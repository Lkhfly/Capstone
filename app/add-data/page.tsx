      ...
      <div>
        ...
        <div className="container mx-auto py-5">
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Description ends */}
            <div>
              <h1 className="font-medium mt-2">Upload any relevant pictures or documents you may have:</h1>
              <button disabled className="mt-2 font-bold border-solid border-2 py-2 px-4 rounded-full">
                Upload
              </button>
            </div>
